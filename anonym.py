...
def filter_spans(span):
    stop_terms = ['договор', 'ип', 'сторона', 'заказчик', 'исполнитель', 'отчет', 'спор', 'приложение', 'заявление', 'покупатель',
     'поставщик', 'представитель', 'продавец', 'арендатор', 'арендодатель', 'контрагент', 'beneficiar', 'инвестор', 'участник',
     'комитент', 'дистрибьютор', 'агрегатор', 'комиссионер', 'principal', 'договорчик', 'подрядчик', 'застройщик',
     'заёмщик', 'кредитор', 'должник', 'гарант', 'поручитель', 'субарендатор', 'субарендодатель', 'договорённость',
     'учредитель', 'директор', 'генеральный директор', 'учредительный документ', 'участник сделки', 'доверенное лицо',
     'лицензиат', 'лицензиар', 'франчайзер', 'франчайзи', 'перевозчик', 'грузоотправитель', 'грузополучатель',
     'страхователь', 'страховщик', 'выгодоприобретатель', 'учредитель', 'акцепт', 'оферента', 'оферта', 'предложение',
     'условие', 'обязательство', 'правообладатель', 'правопреемник', 'ответчик', 'истец', 'посредник', 'экспедитор',
     'клиент', 'партнер', 'соисполнитель', 'соучредитель', 'соинвестор', 'инвестор', 'депозитарий', 'спецификация','экспертиза',
      'адрес', 'счет', 'счёт', 'номер', 'телефон', 'контакт', 'документ', 'протокол', 'заключение', 'договор', 'приложение',
      'приказ', 'указ', 'письмо', 'товар', 'срок', 'деньги', 'предмет', 'субъект', 'статья', 'пункт', 'секция', 'пункт', 'часть','услуги',
      'рф', 'россия', 'российской федерации', 'россии', 'российской', 'работы', 'оборудование', 'субподрядчик', 'персонал', 'работа', 'заказ',
                  ]
